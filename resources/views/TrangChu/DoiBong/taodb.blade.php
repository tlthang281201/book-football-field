...
<header style="margin-top: 0;margin-bottom: 25px;">
		...
		<div class="drop-btn" style="cursor: pointer;">
			<div class="drops-btn" style="z-index: 1000;">
				<a href="http://127.0.0.1:8000/dang-nhap" style="text-decoration: none;font-size: 17px;color: white;padding-right: 20px;">Đăng nhập</a>
			</div>
		</div>
		@endif
	...
	<script type="text/javascript">
	    var drop_btn = document.querySelector('.drops-btn');
