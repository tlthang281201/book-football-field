...
<body>
	...
	<div class="container">
		<div style="text-align: center;margin-top: 50px;">
			<h1>B3: THÀNH CÔNG</h1>
			<a href="http://127.0.0.1:8000/home1"><button class="btn btn-danger" style="margin-bottom: 20px;margin-top: 20px;">TRANG CHỦ</button> </a><br>
			<a href="http://127.0.0.1:8000/tim-doibong"><button class="btn btn-danger" style="margin-bottom: 20px;">TÌM ĐỐI THỦ</button> </a><br>
			<a href="http://127.0.0.1:8000/trangchu/doibong1/profile" class="btn btn-danger" style="margin-bottom: 100px;">ĐỘI BÓNG CỦA TÔI</a>
		</div>
	</div>
	<footer>
		<div class="container">
